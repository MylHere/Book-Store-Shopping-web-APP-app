            ...
            <div class="row"><%-- row 1 --%>
                ...
                <div class="col-sm-6"><%-- cart edit buttons column --%>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <asp:Button ID="btnEmpty" runat="server" Text="Empty Cart" CssClass="btn btn-warning" OnClick="btnEmpty_Click" />
                        </div>
                    </div>
                </div>
            </div><%-- end of row 1 --%>
            ...
            <div class="row"><%-- row 2 --%>
                <div class="col-sm-12">
                    ...
                    <div class="form-group"><%-- buttons --%>
                        <div class="col-sm-12">
                            <asp:Button ID="btnContinue" runat="server" Text="Continue Shopping" CssClass="btn btn-primary" OnClick="btnContinue_Click" />
